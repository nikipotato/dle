...
# %% Train
def train_model(model, loss_fce, optimizer, train_loader, val_loader, device, scheduler,num_epochs=10):
...
# %%
best_model, results = train_model(model, loss, optimizer, train_loader, val_loader, device, scheduler,num_epochs=10)
